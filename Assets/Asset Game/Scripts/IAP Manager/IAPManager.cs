...
public class Key
{
    public const string PACK1 = "add10_eggs";
    public const string PACK2 = "add20_eggs";
    public const string PACK3 = "add50_eggs";
    public const string PACK4 = "add100_eggs";

    public const string PACK1_REGISTER = "register_game42_pack1";
    public const string PACK2_REGISTER = "register_game42_pack2";
    public const string PACK3_REGISTER = "register_game42_pack3";
    public const string PACK4_REGISTER = "register_game42_pack4";
    public const string PACK5_REGISTER = "register_game42_pack5";
}
